...
public class ColorPaletteAdapter extends BaseAdapter {
	 ...
	 * 
	 * @param parent
	 *            The parent of the view, which should be inflated, as an
	 *            instance of the class {@link ViewGroup} or null, if the view
	 ...
	 *            null
	 * @param colorPalette
	 *            The color palette, which should be provided by the adapter, as
	 *            an {@link Integer} array. The color palette may not be null
	 * @param previewSize
	 *            The size, which should be used to preview colors, as an
	 *            {@link Integer} value in pixels. The size must be at least 1
	 * @param previewShape
	 *            The shape, which should be used to preview colors, as a value
	 *            of the enum {@link PreviewShape}. The shape may not be null
	 * @param previewBorderWidth
	 *            The border width, which should be used to preview colors, as
	 *            an {@link Integer} value. The border width must be at least 0
	 * @param previewBorderColor
	 *            The border color, which should be used to preview colors, as
	 *            an {@link Integer} value
	 * @param previewBackground
	 *            The background, which should be used to preview colors, as an
	 *            instance of the class {@link Drawable} or null, if no
	 *            background should be shown
	 */
	public ColorPaletteAdapter(final Context context, final int[] colorPalette, final int previewSize,
			final PreviewShape previewShape, final int previewBorderWidth, final int previewBorderColor,
			final Drawable previewBackground) {
	 ...
	 * 
	 * @param color
	 *            The color, whose index should be returned, as an
	 *            {@link Integer} value
	 * @return The index of the given color or -1, if the adapter does not
	 *         contain the color
	 */
	public final int indexOf(final int color) {
