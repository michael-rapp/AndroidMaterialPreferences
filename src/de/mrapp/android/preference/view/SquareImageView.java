 ...
 * {@link android.widget.ImageView} in order to ensure, that its height is
 * always equal to its width.
 * 
 * @author Michael Rapp
 * 
 * @since 1.4.0
...
public class SquareImageView extends ImageView {
	 ...
	 * 
	 * @param context
	 *            The context, which should be used by the image view, as an
	 ...
	 */
	public SquareImageView(final Context context, final AttributeSet attributeSet, final int defaultStyle) {
