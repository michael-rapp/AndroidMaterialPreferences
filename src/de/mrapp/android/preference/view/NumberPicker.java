 ...
 * {@link android.widget.NumberPicker} in order to provide a setter method,
 * which allows to set the color of the number picker's selectionDivider.
 * 
 * @author Michael Rapp
 *
 * @since 1.1.0
...
public class NumberPicker extends android.widget.NumberPicker {
	 ...
	 * 
	 * @param context
	 *            The context, which should be used by the number picker, as an
	 ...
	 */
	public NumberPicker(final Context context, final AttributeSet attributeSet) {
	 ...
	 * 
	 * @return The color of the number picker's divider as an {@link Integer}
	 *         value
	 */
	 ...
	 */
	public final void setDividerColor(final int color) {
		this.seekBarColor = color;

		try {
			Field divider = getClass().getSuperclass().getDeclaredField(
					"mSelectionDivider");
