 ...
 * palette. The chosen color will only be persisted, if confirmed by the user.
 * 
 * @author Michael Rapp
 * 
 * @since 1.4.0
...
public class ColorPalettePreference extends AbstractColorPickerPreference {
	...
	/**
	 * The border width, which is used to preview colors in the preference's
	 * dialog.
	 */
	private int dialogPreviewBorderWidth;

	/**
	 * The border color, which is used to preview colors in the preference's
	 * dialog.
	 */
	private int dialogPreviewBorderColor;

	/**
	 * The background, which is used to preview colors in the preference's
	 * dialog.
	 */
	private Drawable dialogPreviewBackground;

	/**
	 * The number of columns, which are used to preview colors in the
	 * preference's dialog.
	 */
	private int numberOfColumns;

	/**
	 * The adapter, which provides the colors for visualization using the
	 * preference dialog's grid view.
	 */
	 ...
	 * 
	 * @param attributeSet
	 *            The attribute set, which should be used to initialize the
	...
	private void obtainStyledAttributes(final AttributeSet attributeSet) {
		TypedArray typedArray = getContext().obtainStyledAttributes(attributeSet, R.styleable.ColorPalettePreference);
	 ...
	 * 
	 * @param typedArray
	 *            The typed array, the color palette, should be obtained from,
	...
	/**
	 * Obtains the size, which should be used to preview colors in the
	...
	/**
	 * Obtains the shape, which should be used to preview colors in the
	 * preference's dialog, from a specific typed array.
	 * 
	 * @param typedArray
	...
	/**
	 * Obtains the border width, which should be used to preview colors in the
	 * preference's dialog, from a specific typed array.
	 * 
	 * @param typedArray
	...
	/**
	 * Obtains the border color, which should be used to preview colors in the
	 * preference's dialog, from a specific typed array.
	 * 
	 * @param typedArray
	...
	/**
	 * Obtains the background, which should be used to preview colors in the
	 * preference's dialog, from a specific typed array.
	 * 
	 * @param typedArray
	...
	private void obtainDialogPreviewBackground(final TypedArray typedArray) {
		int backgroundColor = typedArray.getColor(R.styleable.ColorPalettePreference_dialogPreviewBackground, -1);
	...
	/**
	 * Obtains the number of columns, which should be used to preview colors in
	 * the preference's dialog, from a specific typed array.
	 * 
	 * @param typedArray
	 *            The typed array, the number of columns should be obtained
	...
	/**
	 * Creates and returns a listener, which allows to close the preference's
	 * dialog, if a color has been chosen by the user.
	 * 
	...
	/**
	 * Creates a new preference, which allows to choose a color from a
	 ...
	 *            resource
	 */
	public ColorPalettePreference(final Context context, final AttributeSet attributeSet, final int defaultStyle) {
	 ...
	 * 
	 * @return The colors, the preference allows to choose, as an
	 *         {@link Integer} array
	 */
	 ...
	 * 
	 * @param resourceId
	 *            The resource id of the color palette, which should be set, as
	 *            an {@link Integer} value. The resource id must correspond to a
	 *            valid integer array resource
	 */
	...
	/**
	 * Returns the size, which is used to preview colors in the preference's
	 * dialog.
	 * 
	 * @return The size, which is used to preview colors in the preference's
	 *         dialog, as an {@link Integer} value in pixels
	 */
	...
	/**
	 * Sets the size, which should be used to preview colors in the preference's
	 * dialog.
	 * 
	 * @param previewSize
	...
	/**
	 * Returns the shape, which is used to preview colors in the preference's
	 * dialog.
	 * 
	 * @return The shape, which is used to preview colors in the preference's
	 *         dialog, as a value of the enum {@link PreviewShape}. The shape
	 *         may either be <code>CIRCLE</code> or <code>SQUARE</code>
	 */
	...
	/**
	 * Sets the shape, which should be used to preview colors in the
	 * preference's dialog.
	 * 
	 * @param previewShape
	...
	/**
	 * Returns the border width, which is used to preview colors in the
	 * preference's dialog.
	 * 
	 * @return The border width, which is used to preview colors in the
	 *         preference's dialog, as an {@link Integer} value in pixels
	 */
	...
	/**
	 * Sets the border width, which should be used to preview colors in the
	 * preference's dialog.
	 * 
	 * @param borderWidth
	...
	/**
	 * Returns the border color, which is used to preview colors in the
	 * preference's dialog.
	 * 
	 * @return The border color, which is used to preview colors in the
	 *         preference's dialog, as an {@link Integer} value
	 */
	...
	/**
	 * Sets the border color, which should be used to preview colors in the
	 * preference's dialog.
	 * 
	 * @param borderColor
	...
	/**
	 * Returns the background, which is used to preview colors in the
	 * preference's dialog.
	 * 
	 * @return The background, which is used to preview colors in the
	 *         preference's dialog, as an instance of the class {@link Drawable}
	 */
	...
	/**
	 * Returns the number of columns, which are used to preview colors in the
	 * preference's dialog.
	 * 
	 * @return The number of columns, which are used to preview colors in the
	 *         preference's dialog, as an {@link Integer} value
	 */
	...
	/**
	 * Sets the number of columns, which should be used to preview colors in the
	 * preference's dialog.
	 * 
	 * @param numberOfColumns
	 *            The number of columns, which should be set, as an
	 *            {@link Integer} value. The number of columns must be at least
	 *            1
	 */
	...
	protected final void onPrepareDialog(final MaterialDialogBuilder dialogBuilder) {
		adapter = new ColorPaletteAdapter(getContext(), getColorPalette(), getDialogPreviewSize(),
				getDialogPreviewShape(), getDialogPreviewBorderWidth(), getDialogPreviewBorderColor(),
