...
/**
 * An implementation of the abstract class {@link AbstractListPreference}, which is needed for test
 * purposes.
 *
 * @author Michael Rapp
 */
public class AbstractListPreferenceImplementation extends AbstractListPreference {
     ...
     *         {@link Context}
     */
    public AbstractListPreferenceImplementation(final Context context) {
        super(context);
    }
