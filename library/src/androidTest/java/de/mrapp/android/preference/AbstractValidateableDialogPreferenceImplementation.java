 ...
 * @author Michael Rapp
 */
public class AbstractValidateableDialogPreferenceImplementation
        extends AbstractValidateableDialogPreference<CharSequence> {
     ...
     *         {@link Context}
     */
    public AbstractValidateableDialogPreferenceImplementation(final Context context) {
        super(context);
    }
