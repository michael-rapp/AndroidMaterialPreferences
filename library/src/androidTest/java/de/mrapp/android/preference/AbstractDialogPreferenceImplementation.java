...
/**
 * An implementation of the class {@link AbstractDialogPreference}, which is needed for test
 * purposes.
 *
 * @author Michael Rapp
 */
public class AbstractDialogPreferenceImplementation extends AbstractDialogPreference {
     ...
     *         {@link Context}
     */
    public AbstractDialogPreferenceImplementation(final Context context) {
        super(context);
    }
