...
/**
 * An abstract base class for all loaders, which allow to asynchronously load
 * data and show it in a view afterwards.
 *
 * @param <DataType>
 ...
 * @param <ParamType>
 *            The type of parameters, which can optionally be passed to the
 *            loader
 * 
 * @author Michael Rapp
 * 
...
public abstract class AbstractDataLoader<DataType, KeyType, ViewType extends View, ParamType> {
	...
	/**
	 * A map, which is used to manage the views, which have already been used to
	 * show data.
	 */
	private final Map<ViewType, KeyType> views;

	/**
	 * The thread pool, which is used to manage the threads, which are used to
	 ...
	 * 
	 * @param key
	 *            The key of the data, which should be retrieved, as an instance
	 *            of the generic type KeyType. The key may not be null
	 * @return The data, which corresponds to the given key, as an instance of
	 *         the generic type DataType, or null, if no data with the given key
	 *         is contained by the cache
	 */
	...
	/**
	 * Loads the data, which corresponds to a specific key, asynchronously and
	 * shows it afterwards.
	 * 
	 * @param key
	 *            The key of the data, which should be loaded, as an instance of
	 *            the generic type KeyType. The key may not be null
	 * @param view
	 *            The view, which should be used to show the data after it has
	 *            been loaded, as an instance of the generic type ViewType. The
	 *            view may not be null
	 * @param params
	 *            An array, which may contain optional parameters, as an array
	 *            of the generic type ParamType
	 */
	@SuppressWarnings("unchecked")
	@SuppressLint("HandlerLeak")
	private void loadDataAsynchronously(final KeyType key, final ViewType view, final ParamType... params) {
	 ...
	 * 
	 * @return The context, which is used by the data loader, as an instance of
	...
	/**
	 * The method, which is invoked on implementing subclasses, in order to load
	 * the data, which corresponds to a specific key.
	 * 
	 * @param key
	 *            The key of the data, which should be loaded, as an instance of
	 *            the generic type KeyType. The key may not be null
	 ...
	 *            An array, which may contain optional parameters, as an array
	 *            of the generic type ParamType
	 * @return The data, which has been loaded, as an instance of the generic
	 *         type DataType
	 */
	@SuppressWarnings("unchecked")
	...
	/**
	 * The method, which is invoked on implementing subclasses, in order to show
	 ...
	 *            view may not be null
	 * @param data
	 *            The data, which should be shown, as an instance of the generic
	 *            type DataType. The data may not be null
	 */
	protected abstract void showData(final ViewType view, final DataType data);

	/**
	 * Creates a new data loader, which allows to asynchronously load data and
	 * show it in a view afterwards.
	 * 
	 * @param context
	...
	/**
	 * Loads the the data, which corresponds to a specific key, and shows it in
	 * a specific view afterwards. If the data has already been loaded, it will
	 * be retrieved from the cache in order to enhance the performance.
	 * 
	 * @param key
	 *            The key of the data, which should be loaded, as an instance of
	 *            the generic type KeyType. The key may not be null
