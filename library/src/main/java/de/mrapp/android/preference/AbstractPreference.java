...
/**
 * An abstract base class for all of the library's preferences.
 *
 * @author Michael Rapp
 * @since 3.1.2
 */
public abstract class AbstractPreference extends Preference {
     ...
     */
    public AbstractPreference(@NonNull final Context context) {
        super(context);
    }
