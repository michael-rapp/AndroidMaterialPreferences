...
public class ColorPaletteAdapter extends BaseAdapter {
     ...
     */
    public ColorPaletteAdapter(final Context context, final int[] colorPalette,
                               final int previewSize, final PreviewShape previewShape,
                               final int previewBorderWidth, final int previewBorderColor,
