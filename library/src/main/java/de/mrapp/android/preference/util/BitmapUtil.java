...
public final class BitmapUtil {
    ...
    /**
     * Clips the corners of a bitmap in order to transform it into a round shape and resizes it to a
     * specific size. Bitmaps, whose width and height are not equal, will be clipped to a square
     * beforehand.
     *
     * @param bitmap
     ...
     * it into a square and resizes it to a specific size.
     *
     * @param bitmap
     *         The bitmap, which should be clipped, as an instance of the class {@link Bitmap}. The
     *         bitmap may not be null
     ...
     * differs from the bitmap's original ration, the bitmap will be stretched.
     *
     * @param bitmap
    ...
    /**
     * Creates a new utility class, which provides various methods for editing bitmaps.
     */
    private BitmapUtil() {
    ...
    /**
     * Creates a new bitmap with a specific width and height by tiling another bitmap.
     *
     * @param bitmap
    ...
    /**
     * Clips the long edge of a bitmap, if its width and height are not equal, in order to transform
     * it into a square and resizes it to a specific size. Additionally, a border will be added.
     *
     * @param bitmap
     *         The bitmap, which should be clipped, as an instance of the class {@link Bitmap}. The
     *         bitmap may not be null
     ...
     * @return The clipped bitmap as an instance of the class {@link Bitmap}
     */
    public static Bitmap clipSquare(final Bitmap bitmap, final int size, final int borderWidth,
    ...
    /**
     * Clips the corners of a bitmap in order to transform it into a round shape and resizes it to a
     * specific size. Additionally, a border will be added. Bitmaps, whose width and height are not
     * equal, will be clipped to a square beforehand.
     *
     * @param bitmap
     *         The bitmap, which should be clipped, as an instance of the class {@link Bitmap}. The
     *         bitmap may not be null
     ...
     * @return The clipped bitmap as an instance of the class {@link Bitmap}
     */
    public static Bitmap clipCircle(final Bitmap bitmap, final int size, final int borderWidth,
                                    final int borderColor) {
        ensureAtLeast(borderWidth, 0, "The border width must be at least 0");
